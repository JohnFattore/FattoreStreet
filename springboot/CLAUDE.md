...
Run `./mvnw spotless:apply` to fix formatting before committing; CI runs `spotless:check`. See "Code Quality" in `README.md`. Never pass `-Dquality.skip=true` locally, it exists only for the Docker build stage.
