...
from wallstreet.models import Option  # Import your Asset model
...
class OptionCreateTest(APITestCase):
    def setUp(self):
        ...
        self.option = Option.objects.create(ticker='SPY', sunday='2024-2-4')
    ...
    def test_option_create(self):
        data = {'ticker': 'SPY', 'sunday': '2024-2-4'}
