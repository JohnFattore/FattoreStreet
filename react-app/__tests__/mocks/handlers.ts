...
export const handlers = [
  ...
  http.get(portfolioApiBaseUrl.concat("assets/"), () => {
    return Response.json(
      [
        {
          id: 223,
  ...
  http.get(portfolioApiBaseUrl.concat("asset-info/"), () => {
    return Response.json(
      {
        data: [
          {
  ...
  http.get(
    import.meta.env.VITE_APP_SPRINGBOOT_URL.concat("index-members"),
    ({ request }) => {
  ...
  http.get(
    import.meta.env.VITE_APP_SPRINGBOOT_URL.concat("iwb-reference-holdings"),
    () => {
      return Response.json(
        [
  ...
  http.get(portfolioApiBaseUrl.concat("quote/"), () => {
    return Response.json(
      {
        price: 526,
  ...
  http.post(import.meta.env.VITE_APP_SPRINGBOOT_URL.concat("fred-data"), () => {
    return Response.json(
      {
        DGS10: [
          {
  ...
  http.post(usersApiBaseUrl.concat("token/"), () => {
    return Response.json(
      {
        refresh:
          "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoicmVmcmVzaCIsImV4cCI6MTc0MzcyODI2MywiaWF0IjoxNzQzNjQxODYzLCJqdGkiOiJjMzdhYTgwN2EzN2U0NzM1YmEwNjg3ZTU2NTdlOTgwZCIsInVzZXJfaWQiOjR9.0lnm8JXjuQA1g39Sd390WCi7gvLuY-kDeNOdcLcIQzw", // pragma: allowlist secret
        access:
          "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNzQzNjQyMTYzLCJpYXQiOjE3NDM2NDE4NjMsImp0aSI6IjE0Nzc4MDJkNjc4YTQ2OTM5MTMzNmQzMjIzODYxYmFjIiwidXNlcl9pZCI6NH0.1scYah9rH9XcikArJz64MC38VKWIzx0aWv4SdJClxEw", // pragma: allowlist secret
      },
      { status: 200 },
    );
  }),
  ...
  http.post(usersApiBaseUrl.concat("token/refresh/"), () => {
    return Response.json(
      {
        access:
          "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNzQzNjQyMTYzLCJpYXQiOjE3NDM2NDE4NjMsImp0aSI6IjE0Nzc4MDJkNjc4YTQ2OTM5MTMzNmQzMjIzODYxYmFjIiwidXNlcl9pZCI6NH0.refreshed", // pragma: allowlist secret
      },
      { status: 200 },
    );
  }),
  ...
  http.post(
    restaurantsApiBaseUrl.concat("review-create/"),
    async ({ request }) => {
      ...
      [
        {
          ...
          output_text:
            "**Yes** — low-cost index funds are a great core holding.",
  ...
  http.get(
    import.meta.env.VITE_APP_SPRINGBOOT_URL.concat("admin/asset-load"),
    ({ request }) => {
      return new Response("asset-load ok" + new URL(request.url).search, {
        status: 200,
      });
    },
  ),
  ...
  http.get(
    import.meta.env.VITE_APP_SPRINGBOOT_URL.concat("admin/sync-frames"),
    () => {
  ...
  http.get(
    import.meta.env.VITE_APP_SPRINGBOOT_URL.concat("admin/load-hist"),
    ({ request }) => {
      return new Response("load-hist ok" + new URL(request.url).search, {
        status: 200,
      });
    },
  ),
  ...
  http.get(
    import.meta.env.VITE_APP_SPRINGBOOT_URL.concat("admin/adjust-prices"),
    ({ request }) => {
      return new Response("adjust-prices ok" + new URL(request.url).search, {
        status: 200,
      });
    },
  ),
  ...
  http.get(
    import.meta.env.VITE_APP_SPRINGBOOT_URL.concat("admin/summarize-filings"),
    ({ request }) => {
      return new Response(
        "summarize-filings ok" + new URL(request.url).search,
        { status: 200 },
      );
    },
  ),
  ...
  http.post(
    import.meta.env.VITE_APP_SPRINGBOOT_URL.concat(
      "admin/indexes/refresh-stocks",
    ),
    ({ request }) => {
      return new Response("refresh-stocks ok" + new URL(request.url).search, {
        status: 200,
      });
    },
  ),
  ...
  http.post(
    import.meta.env.VITE_APP_SPRINGBOOT_URL.concat("admin/indexes/rebuild"),
    ({ request }) => {
      return new Response("rebuild ok" + new URL(request.url).search, {
        status: 200,
      });
    },
  ),
  ...
  http.get(import.meta.env.VITE_APP_SPRINGBOOT_URL.concat("quarters"), () => {
    return Response.json(
      {
        ticker: "AAPL",
        cik: "0000320193",
  ...
  http.get(import.meta.env.VITE_APP_SPRINGBOOT_URL.concat("prices"), () => {
    return Response.json(
      {
        ticker: "AAPL",
        prices: [
  ...
  http.get(import.meta.env.VITE_APP_SPRINGBOOT_URL.concat("dividends"), () => {
    return Response.json(
      {
        ticker: "AAPL",
        dividends: [
  ...
  http.get(import.meta.env.VITE_APP_SPRINGBOOT_URL.concat("splits"), () => {
    return Response.json(
      {
        ticker: "AAPL",
        splits: [
          ...
          summaries: [
            {
              ...
              summary:
                "Apple reported strong revenue growth driven by iPhone and Services segments. Management highlighted continued investment in AI and machine learning capabilities across the product lineup.",
            },
            {
              filingDate: "2023-11-03",
              accessionNumber: "0000320193-23-000108",
              summary:
                "Revenue declined slightly year-over-year due to macroeconomic headwinds. Services revenue reached an all-time high, partially offsetting hardware weakness.",
            },
          ],
        },
        { status: 200 },
  ...
  http.get(portfolioApiBaseUrl.concat("asset-prices/"), () => {
    return Response.json(
      [
  ...
  http.get(portfolioApiBaseUrl.concat("asset-dividends/"), () => {
    return Response.json(
      [
        { date: "2025-02-10", value: 0.25 },
        { date: "2025-05-12", value: 0.26 },
  ...
  http.get(portfolioApiBaseUrl.concat("asset-splits/"), () => {
    return Response.json(
      [
  ...
  http.get(portfolioApiBaseUrl.concat("quarterly-data/"), () => {
    return Response.json(
      [
        {
          year: 2024,
  ...
  http.post(usersApiBaseUrl.concat("users/"), () => {
    return Response.json(
  ...
  http.post(portfolioApiBaseUrl.concat("accounts/"), () => {
    return Response.json(
  ...
  http.post(portfolioApiBaseUrl.concat("assets/"), () => {
    return Response.json(
      {
        id: 300,
        ticker: "VTI",
  ...
  http.post(changeflowApiBaseUrl.concat("tickets/"), async ({ request }) => {
    const body = (await request.json()) as {
      title?: string;
      description?: string;
    };
