...
const columns = [
  ...
  },
  {
    ...
    render: (row: IYFinanceQuarter) =>
      formatString(row.revenues ?? undefined, "money"),
  },
  {
    label: "Net Income",
    sortKey: "netIncomeLoss",
    render: (row: IYFinanceQuarter) =>
      formatString(row.netIncomeLoss ?? undefined, "money"),
  },
  {
    label: "Operating Income",
    sortKey: "operatingIncomeLoss",
    render: (row: IYFinanceQuarter) =>
      formatString(row.operatingIncomeLoss ?? undefined, "money"),
  },
  {
    label: "Gross Profit",
    sortKey: "grossProfit",
    render: (row: IYFinanceQuarter) =>
      formatString(row.grossProfit ?? undefined, "money"),
  },
  {
    label: "EPS Basic",
    sortKey: "earningsPerShareBasic",
    render: (row: IYFinanceQuarter) =>
      row.earningsPerShareBasic != null
        ? `$${row.earningsPerShareBasic.toFixed(2)}`
        : "—",
  },
  {
    label: "EPS Diluted",
    ...
    render: (row: IYFinanceQuarter) =>
      row.earningsPerShareDiluted != null
        ? `$${row.earningsPerShareDiluted.toFixed(2)}`
        : "—",
  },
  {
    label: "Assets",
    sortKey: "assets",
    render: (row: IYFinanceQuarter) =>
      formatString(row.assets ?? undefined, "money"),
  },
  {
    label: "Liabilities",
    sortKey: "liabilities",
    render: (row: IYFinanceQuarter) =>
      formatString(row.liabilities ?? undefined, "money"),
  },
  {
    label: "Equity",
    sortKey: "stockholdersEquity",
    render: (row: IYFinanceQuarter) =>
      formatString(row.stockholdersEquity ?? undefined, "money"),
  },
  {
    label: "Cash",
    ...
    render: (row: IYFinanceQuarter) =>
      formatString(
        row.cashAndCashEquivalentsAtCarryingValue ?? undefined,
        "money",
      ),
  },
  {
  ...
  },
  {
    ...
    render: (row: IYFinanceQuarter) =>
      formatString(row.inventoryNet ?? undefined, "money"),
  },
  {
    label: "OCF",
    ...
    render: (row: IYFinanceQuarter) =>
      formatString(
        row.netCashProvidedByUsedInOperatingActivities ?? undefined,
        "money",
      ),
  },
  {
    ...
    render: (row: IYFinanceQuarter) =>
      formatString(row.paymentsOfDividends ?? undefined, "money"),
  },
  {
    label: "Buybacks",
    ...
    render: (row: IYFinanceQuarter) =>
      formatString(
        row.paymentsForRepurchaseOfCommonStock ?? undefined,
        "money",
      ),
  },
];
